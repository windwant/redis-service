package com.redis.webapp.service;
...
public class TestRedis {
    ...
    public void opsListRange(String userId, int start, int end) {
        System.out.println(redisTemplate.opsForList().range(userId, start, end));
    }
